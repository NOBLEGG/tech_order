...
function AppInner() {
	...
	return (
		<div className="h-screen flex flex-col overflow-hidden">
			<header className="h-10 flex-shrink-0 bg-white border-b border-gray-100 flex items-center justify-between px-4">
			...
			<DataProvider>
				...
				{editingObjectId && <ObjectModal objectId={editingObjectId} onClose={() => setEditingObjectId(null)} />}
			</DataProvider>
		</div>
	);
}
